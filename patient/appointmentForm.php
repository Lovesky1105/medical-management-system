        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="slot" id="slot" class="custom-select">
              <option value="Slot 1">Slot 1 (9am - 10am)</option>
              <option value="Slot 2">Slot 2 (10am - 11am)</option>
              <option value="Slot 3">Slot 3 (11am - 12pm)</option>
              <option value="Slot 4">Slot 4 (2pm - 3pm)</option>
              <option value="Slot 5">Slot 5 (3pm - 4pm)</option>
            </select>
          </div>
