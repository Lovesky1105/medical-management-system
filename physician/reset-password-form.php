            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="getEmail.php" method="post" novalidate >
                  <?php
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="password_reset" value="password_reset">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="phyRegisterForm.php">Create an account</a></p>
                    </div>
                  </form>
