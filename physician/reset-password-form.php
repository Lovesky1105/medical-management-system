            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="reset-password.php" method="post" novalidate >
                  ...
                  <?php
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="password_reset" value="password_reset">Reset Password</button>
                    </div>
